...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM evaluations."__EFMigrationsHistory" WHERE "MigrationId" = '20250818195139_Initial') THEN
        IF NOT EXISTS(SELECT 1 FROM pg_namespace WHERE nspname = 'evaluations') THEN
            CREATE SCHEMA evaluations;
        END IF;
    END IF;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM evaluations."__EFMigrationsHistory" WHERE "MigrationId" = '20250818195139_Initial') THEN
    CREATE INDEX "IX_form_groups_parent_id" ON evaluations.form_groups (parent_id);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20250818195139_Initial', '9.0.8');
    END IF;
END $EF$;
COMMIT;
