...
{
    private readonly FormCriterionId _criterion;
    ...
    /// </summary>
    public RunCriterionScore(FormCriterionId criterion, bool skipped, ICriterionAssessment assessment)
    {
    ...
    /// </summary>
    public FormCriterionId CriterionId() => _criterion;
