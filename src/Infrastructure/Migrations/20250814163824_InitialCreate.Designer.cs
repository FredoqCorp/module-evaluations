...
namespace CascVel.Module.Evaluations.Management.Infrastructure.Migrations
{
    ...
    [Migration("20250814163824_InitialCreate")]
                    ...
                    b.OwnsOne("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.FormDesign", "Design", b1 =>
                        {
                            ...
                            b1.OwnsMany("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.FormGroup", "Groups", b2 =>
                                {
                                    b2.Property<long>("id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("bigint");
                                    ...
                                    b2.ToTable("form_groups", "evaluations");

                                    b2.WithOwner()
                                        .HasForeignKey("form_id");

                                    b2.OwnsOne("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.ValueObjects.OrderIndex", "Order", b3 =>
                                        {
                                            b3.Property<long>("FormGroupid")
                                                .HasColumnType("bigint");
                                            ...
                                            b3.HasKey("FormGroupid");

                                            b3.ToTable("form_groups", "evaluations");

                                            b3.WithOwner()
                                                .HasForeignKey("FormGroupid");
                                        });

                                    b2.OwnsOne("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.ValueObjects.Weight", "Weight", b3 =>
                                        {
                                            b3.Property<long>("FormGroupid")
                                                .HasColumnType("bigint");
                                    ...
                                    b2.OwnsMany("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.GroupCriterionRef", "Criteria", b3 =>
                                        {
                                            b3.Property<long>("id")
                                                .ValueGeneratedOnAdd()
                                                .HasColumnType("bigint");
                                            ...
                                            b3.Property<long>("criterion_id")
                                                .HasColumnType("bigint")
                                                .HasColumnName("criterion_id");

                                            b3.Property<long>("group_id")
                                                .HasColumnType("bigint");

                                            b3.HasKey("id");

                                            b3.HasIndex("criterion_id");

                                            b3.HasIndex("group_id");

                                            b3.ToTable("group_criteria", "evaluations");

                                            b3.HasOne("CascVel.Module.Evaluations.Management.Domain.Entities.Criteria.Criterion", "Criterion")
                                                .WithMany()
                                                .HasForeignKey("criterion_id")
                                            ...
                                            b3.OwnsOne("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.ValueObjects.OrderIndex", "Order", b4 =>
                                                {
                                                    b4.Property<long>("GroupCriterionRefid")
                                                        .HasColumnType("bigint");
                                                    ...
                                                    b4.HasKey("GroupCriterionRefid");

                                                    b4.ToTable("group_criteria", "evaluations");

                                                    b4.WithOwner()
                                                        .HasForeignKey("GroupCriterionRefid");
                                                });

                                            b3.OwnsOne("CascVel.Module.Evaluations.Management.Domain.Entities.Forms.ValueObjects.Weight", "Weight", b4 =>
                                                {
                                                    b4.Property<long>("GroupCriterionRefid")
                                                        .HasColumnType("bigint");

                                                    b4.Property<decimal>("Percent")
                                                        .HasPrecision(10, 2)
                                                        .HasColumnType("numeric(10,2)")
                                                        .HasColumnName("weight");
