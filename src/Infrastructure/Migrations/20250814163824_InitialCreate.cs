    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_group_criteria", x => x.id);
                    table.ForeignKey(
                        name: "FK_group_criteria_criteria_criterion_id",
                        column: x => x.criterion_id,
                        principalSchema: "evaluations",
                        principalTable: "criteria",
                        principalColumn: "id",
                    ...
                    table.ForeignKey(
                        name: "FK_group_criteria_form_groups_group_id",
                        column: x => x.group_id,
                        principalSchema: "evaluations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_group_criteria_criterion_id",
                schema: "evaluations",
                table: "group_criteria",
                column: "criterion_id");

            migrationBuilder.CreateIndex(
                name: "IX_group_criteria_group_id",
                schema: "evaluations",
                table: "group_criteria",
                column: "group_id");
