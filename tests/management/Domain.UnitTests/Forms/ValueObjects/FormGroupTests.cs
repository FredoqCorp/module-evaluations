...
public sealed class FormGroupTests
{
    ...
    {
        Should.Throw<ArgumentNullException>(() => new FormGroup(null!, new OrderIndex(0), ImmutableList<CascVel.Modules.Evaluations.Management.Domain.Interfaces.IFormCriterion>.Empty, ImmutableList<CascVel.Modules.Evaluations.Management.Domain.Interfaces.IFormGroup>.Empty), "FormGroup accepted a null title which is incorrect");
    }
