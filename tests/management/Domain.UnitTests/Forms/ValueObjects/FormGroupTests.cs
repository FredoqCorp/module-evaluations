...
public sealed class FormGroupTests
{
    ...
    {
        Should.Throw<ArgumentNullException>(() => new FormGroup(null!, new OrderIndex(0), null, ImmutableList<FormCriterion>.Empty, ImmutableList<FormGroup>.Empty), "FormGroup accepted a null title which is incorrect");
    }
