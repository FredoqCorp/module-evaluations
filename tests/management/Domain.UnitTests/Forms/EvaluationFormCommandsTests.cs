...
public sealed class EvaluationFormCommandsTests
{
    ...
    public void EvaluationForm_edit_is_denied_after_publish()
    {
        ...
        Should.Throw<InvalidOperationException>(
            () => form.Edit(meta, new FormGroupList(ImmutableList<FormGroup>.Empty), new FormCriteriaList(ImmutableList<FormCriterion>.Empty), new ArithmeticMeanPolicyDefinition(), new Stamp("e2-✓-" + Guid.NewGuid(), now)),
